if(local player)then{
	...
	private ["_victim", "_range", "_pos", "_h", "_maxh", "_state", "_d", "_dx", "_n", "_positionC", "_particleSourceC"];
	...
	*/
	...
	if (_victim == vehicle _victim) then {
		...
		_particleSourceB = "#particlesource" createVehicleLocal _positionB;
